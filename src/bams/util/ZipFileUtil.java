...
public class ZipFileUtil {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        String file = "g://word_template/办公室综合保险投保单.doc";
        String zipFile1 = "g://word_template/单个文件压缩.zip";
         ...
         * 指定文件路径可以是绝对路径,也可以是相对路径
         */
        String files[] = { "g://word_template/货运险投保单.doc", "g://word_template/机动车投保单.doc" };
        String zipFile2 = "g://word_template/多个文件压缩.zip";
    ...
    public static boolean zipFiles(String[] files, String zipfile)
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            try {
                ...
                // 创建指向压缩原始文件的入口
                //fileName = new String(fileName.getBytes(StringUtil.getEncoding(fileName)),"GB2312");
