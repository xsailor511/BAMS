...
public class ListAllPolicyIndexServlet extends HttpServlet {
	 ...
	 */
	public ListAllPolicyIndexServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		indexlist = piservice.listAllPolicyIndex(start);
		request.setAttribute("indexlist", indexlist);
		this
		.getServletContext().getRequestDispatcher("/jsp/manage/all_policy.jsp?start="+start)
