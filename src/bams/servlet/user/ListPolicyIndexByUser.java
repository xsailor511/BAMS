...
public class ListPolicyIndexByUser extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		indexlist = piservice.getPolicyIndexByUserName(name,start);
		request.setAttribute("indexlist", indexlist);
		RequestDispatcher rd;
	    rd = getServletContext().getRequestDispatcher("/jsp/manage/policyofuser.jsp?username="+name+"&start="+start);
