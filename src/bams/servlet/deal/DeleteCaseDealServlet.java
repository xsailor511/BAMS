...
public class DeleteCaseDealServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		CaseDeal deal = service.getCaseDeal(id);
		if(ps.deletePictureByBaoxiandanhao(deal.getPolicynum())){
			if(service.deleteCaseDeal(id))
				out.write("success");
			else
				out.write("failed");
		}else{
