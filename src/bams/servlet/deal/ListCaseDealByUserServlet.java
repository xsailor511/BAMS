...
public class ListCaseDealByUserServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<CaseDeal> deallist = service.listCaseDealByUser(username, start);
		request.setAttribute("deallist", deallist);
		request.getRequestDispatcher("/jsp/user/all_dealed_policy.jsp?username="+username+"&start="+start)
