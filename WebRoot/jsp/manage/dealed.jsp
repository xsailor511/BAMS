		...
		<div class="sidebar">
			...
			<div class="s-content">
				...
				<ul id="nav">
					...
					<li><a  class="br-blue" href="<%=basePath %>servlet/ListOrderServlet?start=0&page=undeal" >
...
<!-- 						</div> --><table width="100%" border="1" id="mytable">
 ...
 <tr>
	...
	<td align='center' ><div id="input<%=id%>">已受理&nbsp;|&nbsp;<input type="button" class='mybutton' value="取消" onclick="unmarkOrder('<%=id%>')"/></div></td>
		</tr>
  <%
...
<p align="center">
<a href = "<%=basePath%>servlet/ListOrderServlet?start=0&page=dealed" ><font color="blue"><B>首页</B></font></a>
<%
if(start==0){
%>
上一页
...
%>
<a href = "<%=basePath%>servlet/ListOrderServlet?start=<%=start-pageSize%>&page=dealed" ><font color="blue">上一页</font></a>
<%
}
%>
...
%>
<a href = "<%=basePath%>servlet/ListOrderServlet?start=<%=start+pageSize%>&page=dealed" ><font color="blue">下一页</font></a>
<%
}
%>
第<%=pageCount%>页</p>
