		...
		<div class="mainbar">
			...
			<div class="matter">
				<div class="container-fluid">
					...
					<form action="<%=basePath %>servlet/ListQuestionByUserServlet" name="myform" onsubmit="return checkForm()">	
<table width="100%" border="1">
  <tr>
    <td colspan="2" align="center">输入用户名关键字</td>
  </tr>
  <tr>
    <td width="49%" align="right">用户名:<input type="hidden" value="query" name="tag"/></td>
...
<br/><hr/><font color='blue'>查询结果,只显示未回复问题</font>
<div id="result">
<%
