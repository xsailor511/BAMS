		...
		<div class="sidebar">
			...
			<div class="s-content">
				...
				<ul id="nav">
					...
					<li><a  class="br-blue" href="<%=basePath %>servlet/ListAllQuestionServlet?start=0&page=replyed" >
...
<!-- 						</div> --><table width="100%" border="1" id="mytable">
 ...
 <tr>
	...
	<td align='center'><a href="<%=basePath %>servlet/GetQuestionServlet?id=<%=id %>" target="_blank"><font color='blue' >回复</font></a></td>
		</tr>
  <%
		}
...
<p align="center">
<a href = "<%=basePath%>servlet/ListAllQuestionServlet?start=0&page=unreply" ><font color="blue"><B>首页</B></font></a>
<%
if(start==0){
%>
上一页
...
%>
<a href = "<%=basePath%>servlet/ListAllQuestionServlet?start=<%=start-pageSize%>&page=unreply" ><font color="blue">上一页</font></a>
<%
}
%>
...
%>
<a href = "<%=basePath%>servlet/ListAllQuestionServlet?start=<%=start+pageSize%>&page=unreply" ><font color="blue">下一页</font></a>
<%
}
%>
第<%=pageCount%>页</p>
