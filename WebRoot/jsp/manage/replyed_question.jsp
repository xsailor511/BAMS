		...
		<div class="sidebar">
			...
			<div class="s-content">
				...
				<ul id="nav">
					...
					<li><a  class="br-blue" href="<%=basePath %>jsp/manage/query_question.jsp" >
					<i class="icon-user"></i>咨询查询</a></li>
					<li><a  class="br-blue" href="<%=basePath %>servlet/ListAllQuestionServlet?start=0&page=unreply" >
					<i class="icon-user"></i>咨询未回复</a></li>
					<li><a style="color:blue" class="br-blue" >
					<i class="icon-user"></i>咨询已回复</a></li>
				</ul>
...
<!-- 						</div> --><table width="100%" border="1" id="mytable">
 ...
 <tr>
	...
	<td align='center'><a href="javascript:void(0)" onclick="deleteAnswer('<%=id %>')" target="_blank"><font color='red' >删除</font></a></td>
		</tr>
  <%
...
<p align="center">
<a href = "<%=basePath%>servlet/ListAllQuestionServlet?start=0&page=replyed" ><font color="blue"><B>首页</B></font></a>
<%
if(start==0){
%>
上一页
...
%>
<a href = "<%=basePath%>servlet/ListAllQuestionServlet?start=<%=start-pageSize%>&page=replyed" ><font color="blue">上一页</font></a>
<%
}
%>
...
%>
<a href = "<%=basePath%>servlet/ListAllQuestionServlet?start=<%=start+pageSize%>&page=replyed" ><font color="blue">下一页</font></a>
<%
}
%>
第<%=pageCount%>页</p>
...
function deleteAnswer(id){
	//alert("test");
	var url = server_context+"/servlet/UnmarkQuestionServlet?id="+id;
