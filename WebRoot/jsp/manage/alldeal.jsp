		...
		<div class="sidebar">
			...
			<div class="s-content">
				...
				<ul id="nav">
					...
					<li><a style="color:blue" class="br-blue" ><i class="icon-user"></i>保单管理</a></li>
					<li><a href="<%=basePath %>jsp/manage/addcasedeal.jsp" class="br-blue" >
...
<!-- 						</div> --><table width="100%" border="1" id="mytable">
  <tr>
    ...
    <th align="center" valign="middle" scope="col">保单名称</th>
    <th align="center" valign="middle" scope="col">保单号</th>
  ...
  int start = 0 ;
	...
	for(int i=0;i<deallist.size();i++){
		...
		String username = deallist.get(i).getUsername();
  %>
 <tr>
	...
	<td align='center'><a href="javascript:void(0)" onclick="deleteCaseDeal('<%=id%>')"><font color='red' >删除</font></a></td>
		</tr>
  <%
...
<p align="center">
<a href = "<%=basePath%>servlet/ListAllCaseDealServlet?start=0" ><font color="blue"><B>首页</B></font></a>
<%
if(start==0){
%>
上一页
...
%>
<a href = "<%=basePath%>servlet/ListAllCaseDealServlet?start=<%=start-pageSize%>" ><font color="blue">上一页</font></a>
<%
}
%>
...
%>
<a href = "<%=basePath%>servlet/ListAllCaseDealServlet?start=<%=start+pageSize%>" ><font color="blue">下一页</font></a>
<%
}
%>
第<%=pageCount%>页</p>
...
function deleteCaseDeal(id){
	//alert("test");
	var url = server_context+"/servlet/DeleteCaseDealServlet?id="+id;
