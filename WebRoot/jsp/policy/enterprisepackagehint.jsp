			...
			<div class="s-content">
				...
				<ul id="nav">
					...
					<li><a style="color:blue" class="open br-red"><i
							class="icon-home"></i>中小企业一揽子保险投保流程</a> <!-- Sub menu markup 
              <ul>
			...
			<div class="matter">
				<div class="container-fluid">
					...
					<div class="box-body" style="background:#CCDDFF;color:black">
												...
												<h5>中小企业一揽子保险投保流程</h5><br/>
<img src="<%=basePath %>img/hint/employerdutyhint.jpg" />
<br/><br/><br/>
<p style="text-align:center;color:red">
<a href="<%=basePath %>jsp/policy/enterprisepackage.jsp"><font color="blue">我已详细了解投保流程</font></a>
</p>
					</div>
				</div>
			</div>
