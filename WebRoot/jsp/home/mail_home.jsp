...
if(null==role_int){
	...
	if(null==session_name||role!=6){//if the user is not login or a manager.
...
<title><%=session.getAttribute("name") %>-企业邮政</title>
			...
			<div class="s-content">
				...
				<ul id="nav">
					...
					<li><a style="color:blue" class="open br-red"><i
							class="icon-home"></i>企业邮政用户</a> <!-- Sub menu markup 
              <ul>
                ...
                <li><a href="<%=basePath %>#">Submenu #3</a></li>
					...
					<li><a href="<%=basePath %>jsp/home/mail_shuoming.jsp" target="_blank" class="br-blue"><i
...
<img alt="test" src="<%=basePath %>img/policy/freight.jpg" width="100%"></a></div>
