		...
		<div class="sidebar">
			...
			<div class="s-content">
				...
				<ul id="nav">
					...
					<li><a style="color:blue" class="open br-red"><i class="icon-home" ></i>未回复</a> 
...
<p align="center">
<a href = "<%=basePath%>servlet/ListQuestionByUserServlet?start=0&tag=unreply&key=<%=session_name %>" ><font color="blue"><B>首页</B></font></a>
<%
if(start==0){
%>
上一页
...
%>
<a href = "<%=basePath%>servlet/ListQuestionByUserServlet?start=<%=start-pageSize%>&tag=unreply&key=<%=session_name %>" ><font color="blue">上一页</font></a>
<%
}
%>
...
%>
<a href = "<%=basePath%>servlet/ListQuestionByUserServlet?start=<%=start+pageSize%>&tag=unreply&key=<%=session_name %>" ><font color="blue">下一页</font></a>
<%
}
%>
第<%=pageCount%>页</p>
