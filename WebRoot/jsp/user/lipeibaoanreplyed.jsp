...
<!-- 						</div> --><table width="100%" border="1" id="mytable">
 ...
 <tr>
	...
	<td align='center'><a href="<%=basePath %>servlet/GetReplyCaseServlet?id=<%=id %>" target="_blank"><font color='blue' >查看</font></a></td>
		</tr>
  <%
...
<p align="center">
<a href = "<%=basePath%>servlet/ListCaseByUserServlet?start=0&page=replyed&username=<%=session_name %>" ><font color="blue"><B>首页</B></font></a>
<%
if(start==0){
%>
上一页
...
%>
<a href = "<%=basePath%>servlet/ListCaseByUserServlet?start=<%=start-pageSize%>&page=replyed&username=<%=session_name %>" ><font color="blue">上一页</font></a>
<%
}
%>
...
%>
<a href = "<%=basePath%>servlet/ListCaseByUserServlet?start=<%=start+pageSize%>&page=replyed&username=<%=session_name %>" ><font color="blue">下一页</font></a>
<%
}
%>
第<%=pageCount%>页</p>
