...
<p align="center">
<a href = "<%=basePath%>servlet/ListOrderByUserServlet?start=0&page=undeal&username=<%=session_name %>" ><font color="blue"><B>首页</B></font></a>
<%
if(start==0){
%>
上一页
...
%>
<a href = "<%=basePath%>servlet/ListOrderByUserServlet?start=<%=start-pageSize%>&page=undeal&username=<%=session_name %>" ><font color="blue">上一页</font></a>
<%
}
%>
...
%>
<a href = "<%=basePath%>servlet/ListOrderByUserServlet?start=<%=start+pageSize%>&page=undeal&username=<%=session_name %>" ><font color="blue">下一页</font></a>
<%
}
%>
第<%=pageCount%>页</p>
