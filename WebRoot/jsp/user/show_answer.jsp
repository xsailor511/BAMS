...
<jsp:useBean id="answer" class="bams.entity.Answer" scope="request"/>
			...
			<div class="s-content">
				...
				<ul id="nav">
					...
					<li><a style="color:blue" class="open br-red"><i
							class="icon-home"></i>查看咨询回复</a> <!-- Sub menu markup 
              <ul>
...
<table width="600px" border="1">
  <tr>
    <td align="left"><jsp:getProperty name="question" property="username" />的问题：</td>
    
  </tr>
  <tr>
    
    <td align="left" height="260px" valign="top"><jsp:getProperty name="question" property="content" /></td>
  ...
  <tr>
     <td align="left" height="260px" valign="top"><jsp:getProperty name="answer" property="reply" /></td>
  </tr>
