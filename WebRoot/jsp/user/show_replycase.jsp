...
<jsp:useBean id="replycase" class="bams.entity.ReplyCase" scope="request"/>
			...
			<div class="s-content">
				...
				<ul id="nav">
					...
					<li><a style="color:blue" class="open br-red"><i
							class="icon-home"></i>查看报案回复</a> <!-- Sub menu markup 
              <ul>
...
<table width="600px" border="1">
  <tr>
    <td align="left"><jsp:getProperty name="mycase" property="username" />的问题：</td>
    
  </tr>
  <tr>
    
    <td align="left" height="260px" valign="top"><jsp:getProperty name="mycase" property="shigujingguo" /></td>
    
  </tr>
  <tr>
    
    <td align="left">管理员的回答：</td>
   
  </tr>
  
  <tr>
     <td align="left" height="260px" valign="top"><jsp:getProperty name="replycase" property="content" /></td>
  </tr>
